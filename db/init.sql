...
DECLARE
    ...
    passwords TEXT[] := ARRAY['seguridadinformacion', 'qwerty', '123456', 'letmein', 'admin123', 'welcome', 'godmode', 'secret', 'password', 'hunter2', 'ninja', 'football', 'baseball', 'monkey', 'dragon', 'shadow', 'superman', 'batman', 'starwars'];
